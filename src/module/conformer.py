...
class ConformerEncoder(torch.nn.Module):
    def __init__(
        ...
        logging.info(f"Pos layers - {pos_enc_layer_type}")
        ...
        logging.info(f"self attn args: {encoder_selfattn_layer_args}")
        ...
        logging.info(f"position-wise args: {positionwise_layer_args}")
